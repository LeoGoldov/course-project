...
- ❤️ **Система избранного** — пользователи могут сохранять команды и просматривать их в личном кабинете
...
- ✏️ **Управление командой** — капитан может редактировать данные и снимать команду с публикации
...
Период разработки: май – июнь 2026

Средняя частота: ~2 коммита/день

Репозиторий: github.com/LeoGoldov/course-project

👨‍💻 Автор
Студент: Жерлицын Вячеслав
Группа: ПИЖ-б-о-24-1
Направление: 09.03.04 «Программная инженерия»
Профиль: «Разработка и сопровождение программного обеспечения»

Руководитель: Самойлов Ф.В.
